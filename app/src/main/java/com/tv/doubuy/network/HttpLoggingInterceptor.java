...
public final class HttpLoggingInterceptor implements Interceptor {
    ...
    public enum Level {
        ...
        NONE,
        /**
         * Logs request and response lines. <p> Example:
         * <pre>{@code
        ...
        BASIC,
        /**
         * Logs request and response lines and their respective headers. <p> Example:
         * <pre>{@code
        ...
        HEADERS,
        /**
         * Logs request and response lines and their respective headers and bodies (if present). <p>
         * Example:
         * <pre>{@code
         * --> POST /greeting HTTP/1.1
         * Host: example.com
