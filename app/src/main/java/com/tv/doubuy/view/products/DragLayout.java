...
/**
 * @Module :
 * @Comments : 这是一个viewGroup容器，实现上下两个frameLayout拖动切换
 * @Author : sistone.Zhang
 * @CreateDate : 2016-07-10
 * @ModifiedBy : sistone.Zhang
...
public class DragLayout extends ViewGroup {
    ...
    public void setBottomToTop() {
        //onViewPosChanged(1,-948);
        //mDragHelper.dispatchViewReleased(0,-948);


        Class<?> classType = mDragHelper.getClass();
        Method method = null;
        try {
            method = classType.getDeclaredMethod("dispatchViewReleased", new Class[]{float.class,float.class});
        ...
        try {
            method.invoke(mDragHelper, new Object[]{0, -948});
	...
	/*	// 下一页可以初始化了
		...
		if (mDragHelper.smoothSlideViewTo(frameView2, 0, -948)) {
			ViewCompat.postInvalidateOnAnimation(this);
		}*/
    }
